...
import MedicalRecordMenu from '@/components/Extras/MedicalRecordMenu.vue';
import RecipeInput from '@/components/Form/RecipeInput.vue'
import RecipeCompoundInput from '@/components/Form/RecipeCompoundInput.vue'
import LabolatoriumForm from '@/components/Form/LabolatoriumForm.vue'
import ExaminationForm from '@/components/Form/ExaminationForm.vue'
...
<template>
  <section class="anim-slide" ref="pages">
    ...
    <div style="padding: 0.5rem; padding-top: 2rem; padding-bottom: 2rem;">
      <form class="form-search-input" v-on:submit.prevent="handleGetAmbulatoryData">
        <div class="box-search">
          <div class="box">
            <input class="search-input" type="datetime-local" step="1" id="dt1" v-model="dateSearch1" placeholder="date">
            <input class="search-input" type="datetime-local" step="1" id="dt2" v-model="dateSearch2" placeholder="date">
            <input class="search-input" type="text" id="sc" v-model="searchAmbulatory" placeholder="No Rawat/Nama Pasien">
          </div>
          <button type="submit">
            <p>Search</p>
      ...
      <form class="form-search-input" v-on:submit.prevent="handleGetRegister">
        <div class="box-search">
          <div class="box">
            ...
            <input class="search-input" type="number" id="sc" v-model="search.limit" placeholder="limit">
            <input class="search-input" type="text" id="sc" v-model="search.search" placeholder="No Rawat/Nama Pasien">
          </div>
          <button type="submit">
            <p>Search</p>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="384px" height="384px">
