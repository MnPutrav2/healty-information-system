  ...
  <teleport to='body'>
    <section class="container center" >
      <div class="cover2 scroll">
        ...
        <div ref="pageScroll" style="padding: 0.5rem; padding-top: 2rem; padding-bottom: 2rem;" v-if="recipeCompounds.length != 0 && indexName != null">
          <form class="form-search-input" v-on:submit.prevent="handleGetDrugData">
            <div class="box-search">
              <div class="box">
                <input class="search-input" type="text" id="ns" v-model="indexName" readonly placeholder="Nama obat">
